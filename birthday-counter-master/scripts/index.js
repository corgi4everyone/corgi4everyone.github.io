...
let countDown = new Date("October 25,2020 00:00:00").getTime();
x = setInterval(function() {
  ...
  let w = (c.width = window.innerWidth),
    ...
    hh = h / 2,
    opts = {
      strings: ['A wish for you on your birthday,','whatever you ask may you receive,','whatever you seek may you find,', "whatever you wish"," may it be fulfilled", "on your birthday and always...", "\n", 'HAPPY BIRTHDAY!', "Chue"],
      charSize: 30,
      charSpacing: 35,
      lineHeight: 40,
